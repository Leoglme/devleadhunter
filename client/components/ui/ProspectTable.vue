        ...
        >
          ...
          <td class="px-3 py-2.5">
            <span
              ...
              class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-[#238636]/20 text-[#3fb950]"
            >
              Has Website
            </span>
            <span
              v-else
              class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-[#da3633]/20 text-[#f85149]"
            >
              No Website
            </span>
          </td>
