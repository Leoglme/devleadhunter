<template>
  <div>
    <h1 class="text-2xl font-semibold text-white mb-4">Prospect Search</h1>

    <!-- Search Form -->
    <div class="card mb-6">
      <h2 class="text-sm font-semibold text-white mb-3">Search Criteria</h2>
      <UiSearchForm />
    </div>
    ...
    <div v-if="prospectsStore.isLoading" class="card">
      <div class="animate-pulse space-y-3">
        ...
        <div class="h-4 bg-[#1c2128] rounded w-5/6"></div>
      </div>
    </div>
    ...
    <div v-else class="card text-center py-12">
      <i class="fa-solid fa-magnifying-glass text-5xl text-muted mb-3"></i>
      <p class="text-muted">Start a search to find prospects</p>
    </div>
  </div>
</template>
