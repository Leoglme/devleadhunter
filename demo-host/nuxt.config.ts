...
export default defineNuxtConfig({
  ...
  extends: [
    'github:DevLeadHunter/devleadhunter-template-artisan-edito#v1.2.1',
    'github:DevLeadHunter/devleadhunter-template-plumber-signature#v1.2.1',
    'github:DevLeadHunter/devleadhunter-template-plumber-atelier#v1.3.1',
    'github:DevLeadHunter/devleadhunter-template-plumber-cuivre#v1.2.1',
    'github:DevLeadHunter/devleadhunter-template-electrician-lumen#v1.2.1',
    'github:DevLeadHunter/devleadhunter-template-mechanic-pitlane#v1.3.1',
    ...
    'github:DevLeadHunter/devleadhunter-template-landscaper-verdure#v1.1.0',
  ],
