...
export default defineNuxtConfig({
  ...
  extends: [
    ...
    'github:DevLeadHunter/devleadhunter-template-dental#v1.1.2',
    'github:DevLeadHunter/devleadhunter-template-food#v1.0.4',
    'github:DevLeadHunter/devleadhunter-template-barber#v1.1.3',
  ],
