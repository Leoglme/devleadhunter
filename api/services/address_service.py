...
class AddressService:
    ...
    def remove_postal_code(self, address: str | None) -> str | None:
        """
    ...
    def remove_city(self, address: str | None, city: str | None) -> str | None:
        """
    ...
    def remove_city_and_postal_code(self, address: str | None, city: str | None) -> str | None:
        """
